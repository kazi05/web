...
extension Manifest {
    public struct Image: Codable {
        ...
        public struct Size: Codable, ExpressibleByStringLiteral, CustomStringConvertible {
            ...
            @MainActor public static var x48: Self = "48x48"
            @MainActor public static var x72: Self = "72x72"
            @MainActor public static var x96: Self = "96x96"
            @MainActor public static var x128: Self = "128x128"
            @MainActor public static var x144: Self = "144x144"
            @MainActor public static var x152: Self = "152x152"
            @MainActor public static var x192: Self = "192x192"
            @MainActor public static var x256: Self = "256x256"
            @MainActor public static var x512: Self = "512x512"
        }
        ...
        public struct ImageType: Codable, ExpressibleByStringLiteral, CustomStringConvertible {
            ...
            /// image/png
            @MainActor public static var png: Self = "image/png"
            
            /// image/webp
            @MainActor public static var webp: Self = "image/webp"
        }
        ...
        public struct Purpose: Codable, ExpressibleByStringLiteral, CustomStringConvertible {
            ...
            @MainActor public static var monochrome: Self = "monochrome"
            ...
            @MainActor public static var maskable: Self = "maskable"
            
            /// The user agent is free to display the icon in any context (this is the default value).
            @MainActor public static var any: Self = "any"
        }
    }
}
